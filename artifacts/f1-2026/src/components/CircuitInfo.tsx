        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 sm:gap-3">
          ...
          <StatCard
            ...
            action={hasMap ? (
              ...
              >
                <span className="text-sm leading-none" role="img" aria-label="map">🗺️</span>
              </button>
            ) : undefined}
          />
        </div>
...
function StatCard({
  icon, label, value, sub, highlight, fullWidthMobile, action,
}: {
