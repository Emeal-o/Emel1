...
// Official F1 fastest lap purple
...
export default function RaceResults({ results }: { results: RaceResult[] }) {
  ...
  return (
    <div className="flex flex-col gap-6">
            ...
            >
              <div className="flex flex-col items-center gap-1">
                ...
                <div
                  ...
                  style={{ height: driver.position === 1 ? "28px" : driver.position === 2 ? "20px" : "14px", backgroundColor: color }}
                />
              ...
              <div
                ...
                style={{
                  height: driver.position === 1 ? "96px" : driver.position === 2 ? "64px" : "48px",
      ...
      {/* Fastest lap callout (if in top 3, still shown here) */}
      {flDriver && (
        <div
      ...
      <div className="border border-border/50 rounded-xl overflow-hidden bg-black/20">
        <div className="grid grid-cols-[1.5rem_auto_1fr_auto] sm:grid-cols-[2rem_auto_1fr_auto_auto] gap-x-2 sm:gap-x-3 px-3 sm:px-4 py-2 text-[10px] font-bold uppercase tracking-widest text-muted-foreground border-b border-border/50 bg-black/20">
          ...
          <span className="text-right hidden sm:block w-24">Time</span>
        </div>
        ...
        {rest.map((driver, i) => {
          ...
          return (
            <motion.div
              ...
              className="grid grid-cols-[1.5rem_auto_1fr_auto] sm:grid-cols-[2rem_auto_1fr_auto_auto] gap-x-2 sm:gap-x-3 px-3 sm:px-4 py-2 sm:py-2.5 items-center border-b border-border/20 last:border-0 transition-colors"
              style={isFl ? {
                backgroundColor: `${FL_COLOR}0d`,
                borderLeft: `2px solid ${FL_COLOR}`,
              } : undefined}
            >
